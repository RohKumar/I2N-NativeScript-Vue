...
(ii) neither  nor its Affiliates are obliged to promote your Items; and (iii)  and its Affiliates may remove Items from the Littichoka  App in the circumstances described in this Agreement.
 ...
 (c)  may authorise you to use automated tools that allow you to feature Promotions to your customers through the Littichoka  App. All Promotions will be subject to ’s prior written approval. You are the only person responsible for fulfilling and, 
...
(a) After receiving an Item, your customer may be prompted by the Littichoka  App to provide a rating of that Item and any feedback related to you or that Item (Customer Feedback).
 ...
 (b)  and its Affiliates may use, share, and display Customer Feedback for any purpose related to their businesses without attribution to you or your approval. You acknowledge that  and its Affiliates are distributors (without any obligation to verify) and not publishers of Customer Feedback, provided that  and its Affiliates may edit or remove comments in the event that such comments include obscenities or other objectionable content, include an individual’s name or other Personal Data, violate any privacy or other applicable Laws, ’s or its Affiliates’ content policies.
"
...
(ii) the distance from your location to your customer’s delivery address;
...
(i) copy, modify, distribute, sell or lease any part of the Littichoka Tool or any other Littichoka Materials;
 ...
 (ii) reverse engineer or attempt to extract the source code of Littichoka’s or its Affiliates’ software, except to the extent allowed by Law; or
...
(a) You grant to Littichoka and  (and their Affiliates) a licence to use your Marks and Littichoka grants to you a licence to use Littichoka’s Marks, each subject to the terms of this Agreement. You are only permitted to use Littichoka’s Marks, and Littichoka,  and their Affiliates are only permitted to use your Marks, for the purpose of performing the activities permitted in this Agreement (including promotional activities under section 3.3).
...
6.6 Feedback
 ...
 (a) You may, but are not required to, provide feedback relating to ’s, Littichoka's and/or their Affiliate’s products and services (Feedback). 
...
(a) The terms and conditions of Littichoka’s privacy policy, currently available at https://privacy.littichoka.com/policy/, will apply to Littichoka’s collection, use and processing of Personal Data. 
...
(a) Subject to section 11.2(b), in no event will a party be liable for any claim for any indirect, wilful, punitive, incidental, exemplary, special or consequential damages, for loss of business profits, or damages for loss of business of Merchant or any third party arising out of this Agreement, or loss or inaccuracy of data of any kind, whether based on contract, tort or any other legal theory, even if the party has been advised of the possibility of such damages.
 ...
 (b) Subject to section 11.2(b), Littichoka's and ’s combined total cumulative liability of each and every kind to you under this Agreement will not exceed AU$100,000, and your total cumulative liability of each and every kind to Littichoka this Agreement will not exceed AU$100,000. 
...
(a) Subject to section 11.2(b), the limitations and exclusions set out in section 11.1 do not apply to a party’s indemnification obligations or a breach of confidentiality
...
(a) Each party must maintain the following insurances during the Term and for one year thereafter: No. Description Scope and Details 1. Commercial general liability insurance As set out on your Order Form. 2. Workers’ compensation insurance As set out on your Order Form.

 (b) The above insurance policies must be provided by reputable insurance companies authorised to do business in Australia and hold a Best’s policyholder rating of not less than A VII.
...
(i) you commit a material breach of this Agreement; or
 ...
 (ii) an act or omission by you, in Littichoka’s ’s reasonable judgment, is in violation of the Community Guidelines or has the potential to cause adverse publicity, media attention or regulatory scrutiny or other issues that could detrimentally impact the reputation, good name, brand or Marks of Littichoka,  or any of their Affiliates, including matters of safety (a Brand Matter). 
...
(ii) one day after being sent by overnight courier (charges prepaid);
 ...
 (i) for an Order Form, providing you with a new Order Form Variation by email – the modification will take effect from the Variation Effective Date set out in that form; or

 (ii) for the General Terms, publishing a new version on the Littichoka website and letting you know by email – the modification will take effect from the date the General Terms are published on the Littichoka website.
