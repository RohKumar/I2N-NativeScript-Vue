        ...
        <GridLayout rows="auto,auto,*,auto" columns="auto">
            ...
            <GridLayout row="0" ref="navStatusBar" class="navStatusBar"
                ...
                <Image col="1" row="0" @tap="search"
                    horizontalAlignment="right" class="status-img"
            ...
            <GridLayout row="1" ref="navTab" class="navTab"
                ...
                <GridLayout class="tabview"
                    :class="selectedTabview==0?'active':''" @tap="popular"
                    rows="*,auto" cols="auto" col="0" row="0" width="33%">
                ...
                <GridLayout class="tabview"
                    ...
                    @tap="showCategory" rows="*,auto" cols="auto" col="1"
                    row="0" width="34%">
                    <Image v-show="selectedTabview == 1" row="0"
                        class="navIcon"
                ...
                <GridLayout class="tabview"
                    :class="selectedTabview==2?'active':''" @tap="showPromos"
                    rows="*,auto" cols="auto" col="2" row="0" width="33%">
                    <Image v-show="selectedTabview == 2" row="0"
                        class="navIcon"
            ...
            <GridLayout v-show="selectedTabview == 0" row="2" width="100%"
                ...
                <ListView ref="listview" separatorColor="transparent"
                    for="item in items" :key="index">
                    <v-template>
            ...
            <GridLayout v-show="selectedTabview == 1" row="2" width="100%"
                backgroundColor="white">
                <ListView ref="listview" separatorColor="transparent"
                    for="item in itemsCategory" :key="index">
                    <v-template>
